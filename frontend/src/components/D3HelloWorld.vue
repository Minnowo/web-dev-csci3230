...
<template>
  <div class="flex flex-col items-center justify-center p-8">
    ...
    <div
      class="p-4 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 transition-colors duration-300"
    >
