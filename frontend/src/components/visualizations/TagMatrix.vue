...
function draw({ tags, matrix }) {
  ...
  g.selectAll(".col-label")
    ...
    .attr(
      "transform",
      (d, i) => `rotate(-45, ${i * cellSize + cellSize / 2}, -8)`,
    )
    .text((d) => d)
  ...
  <div class="flex flex-col h-full bg-gray-950 text-gray-100 p-4">
    ...
    <div class="mb-6">
      ...
      <p class="text-sm text-gray-500 mt-1">
        How often pairs of tags appear together on the same note
      </p>
    </div>
    ...
    <Teleport to="body">
      ...
      >
        ...
        <p class="text-gray-400">
          Co-occur in
          <span class="text-white font-semibold">{{ hoveredCell.value }}</span>
